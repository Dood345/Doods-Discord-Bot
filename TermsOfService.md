...
This Terms of Service Agreement (the "Agreement") is entered into between Dood345 ("Bot Owner") and the user ("User") of the Doods's Edgy Assistant Bot Discord bot (the "Bot").
...
8. Governing Law: This Agreement shall be governed by and construed in accordance with the laws of Iowa, USA. Any dispute arising under or in connection with this Agreement shall be resolved by arbitration in accordance with the rules of the Iowa Arbitration Commission.
